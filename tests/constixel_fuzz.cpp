...
void fuzz_limits() {
    ...
    for (size_t c = 0; c < 65536; c++) {
        ...
        if constexpr (AA) {
            ...
            image.draw_line_aa(random_limit(),random_limit(),random_limit(),random_limit(),static_cast<uint8_t>(random_limit()&0xFF),static_cast<float>(random_limit()));
            ...
            image.fill_rect(random_limit(), random_limit(), random_limit(), random_limit(), [](float u, float v, int32_t px, int32_t py) -> std::array<float, 4> { return {{u, v, static_cast<float>(px), static_cast<float>(py)}}; });
            image.fill_circle_aa(random_limit(), random_limit(), random_limit(), [](float u, float v, int32_t px, int32_t py) -> std::array<float, 4> { return {{u, v, static_cast<float>(px), static_cast<float>(py)}}; });
            image.fill_round_rect_aa(random_limit(), random_limit(), random_limit(), random_limit(), random_limit(), [](float u, float v, int32_t px, int32_t py) -> std::array<float, 4> { return {{u, v, static_cast<float>(px), static_cast<float>(py)}}; });
...
void fuzz_random() {
    ...
    for (size_t c = 0; c < 65536; c++) {
        ...
        if constexpr (AA) {
            ...
            image.draw_line_aa(random_int32(),random_int32(),random_int32(),random_int32(),static_cast<uint8_t>(random_int32()&0xFF),static_cast<float>(random_int32()));
            image.fill_circle_aa(random_int32(), random_int32(), random_int32(), static_cast<uint8_t>(random_int32()&0xFF));
            image.fill_rect(random_int32(), random_int32(), random_int32(), random_int32(), [](float u, float v, int32_t px, int32_t py) -> std::array<float, 4> { return {{u, v, static_cast<float>(px), static_cast<float>(py)}}; });
            image.fill_circle_aa(random_int32(), random_int32(), random_int32(), [](float u, float v, int32_t px, int32_t py) -> std::array<float, 4> { return {{u, v, static_cast<float>(px), static_cast<float>(py)}}; });
            image.fill_round_rect_aa(random_int32(), random_int32(), random_int32(), random_int32(), random_int32(), [](float u, float v, int32_t px, int32_t py) -> std::array<float, 4> { return {{u, v, static_cast<float>(px), static_cast<float>(py)}}; });
