...
declare -A meta=(
  ...
  [file40:name]=NotoSansSymbols2-Regular.ttf                   [file40:size]=32       [file40:flags]="--chars 0x2300-0x23ff,0x2190-0x21ff,0x25A0-0x25FF"
)
...
while IFS= read -r f; do
    ...
    base="${base%.*}"
    flags=${meta[$f:flags]//\"}
    ./fontbm/build/fontbm --font-file "special/$font" --output "build/${base}" --font-size "${meta["$f:size"]}" ${flags} --force-auto-hinter --extra-info --texture-crop-width --texture-crop-height
